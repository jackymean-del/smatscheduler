    ...
    <div style={{ fontFamily: "'Inter', -apple-system, sans-serif", background: '#fff', color: '#13111E', minHeight: '100vh' }}>
      ...
      <section style={{
        ...
        <h1 className="lp-hero-animate" style={{
          ...
          color: '#13111E', maxWidth: 680, marginBottom: 18,
        }}>
          Your school timetable,<br />
          <span style={{ color: '#7C6FE0', fontStyle: 'italic' }}>generated by AI.</span>
        </h1>

        {/* Sub-copy — globally neutral */}
        <p className="lp-hero-animate" style={{
          animationDelay: '0.16s',
          fontSize: 16, color: '#4B5275', maxWidth: 500,
          lineHeight: 1.75, marginBottom: 36, fontWeight: 400,
        }}>
          schedU intelligently allocates periods, teachers, and rooms — and builds
          conflict-free timetables in minutes, not days.
          Works with <strong style={{ color: '#13111E', fontWeight: 600 }}>any board</strong>,
          any curriculum, anywhere in the world.
        </p>
